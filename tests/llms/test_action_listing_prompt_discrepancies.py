...
def prompt_contents() -> dict[str, str]:
    ...
    optim_path: Path = project_root / "blanche/llms/prompts/action-listing/optim/user.md"
    incr_path: Path = project_root / "blanche/llms/prompts/action-listing-incr/user.md"
