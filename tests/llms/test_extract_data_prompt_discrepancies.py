...
def prompt_contents() -> dict[str, str]:
    ...
    raw_path: Path = project_root / "blanche/llms/prompts/data-extraction/all_data/user.md"
    relevant_path: Path = project_root / "blanche/llms/prompts/data-extraction/only_main_content/user.md"
