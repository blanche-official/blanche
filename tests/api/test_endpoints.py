...
# def get_api_key() -> str:
#     api_key = os.environ.get("BLANCHE_TEST_API_KEY")
#     if api_key is None:
#         raise ValueError("BLANCHE_TEST_API_KEY is not set")
#     return api_key
...
#     # test step with invalid session_id or empty session_id should raise BlancheInternalError
#     # test step with freshly closed session_id should raise BlancheInternalError
