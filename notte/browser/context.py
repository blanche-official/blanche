...
from blanche.browser.node_type import InteractionNode, NodeCategory, BlancheNode
...
class Context:
    ...
    @staticmethod
    def format(node: BlancheNode, indent_level: int = 0, include_ids: bool = True, include_images: bool = False) -> str:
        indent = "  " * indent_level
    ...
    def subgraph_without(self, actions: list[Action]) -> "Context | None":
        ...
        def only_failed_actions(node: BlancheNode) -> bool:
