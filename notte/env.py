...
from blanche.actions.base import (
    Action,
    ActionParameter,
...
from blanche.actions.code import process_action_code
from blanche.browser.context import Context
from blanche.browser.driver import BrowserArgs, BrowserDriver
from blanche.browser.observation import Observation
from blanche.browser.snapshot import BrowserSnapshot
from blanche.common.logging import timeit
from blanche.common.resource import AsyncResource
from blanche.llms.service import LLMService
from blanche.pipe.data_scraping import DataScrapingPipe
from blanche.pipe.main import BaseContextToActionSpacePipe, ContextToActionSpacePipe
from blanche.pipe.preprocessing.a11y.pipe import ActionA11yPipe
from blanche.pipe.resolution import ActionNodeResolutionPipe
from blanche.sdk.types import DEFAULT_MAX_NB_ACTIONS
...
class BlancheEnv(AsyncResource):
    def __init__(
        self,
        max_steps: int = 30,
