...
from blanche.browser.driver import BrowserDriver
from blanche.browser.node_type import BlancheNode
from blanche.data.space import DataSpace, ImageCategory, ImageData
from blanche.llms.engine import StructuredContent
from blanche.llms.service import LLMService
from blanche.pipe.preprocessing.a11y.tree import ProcessedA11yTree
from blanche.sdk.types import ScrapeRequest, ScrapeRequestDict
from blanche.utils.image import construct_image_url
...
async def resolve_image_conflict(page: Page, node: BlancheNode, node_id: str) -> Locator | None:
    ...
    async def forward(
        ...
        **param: Unpack[ScrapeRequestDict],
        ...
        if len(self.token_encoder.encode(document)) > self.max_tokens:
            ...
            simple_node = BlancheNode.from_a11y_node(tree.simple_tree, path=context.snapshot.metadata.url)
