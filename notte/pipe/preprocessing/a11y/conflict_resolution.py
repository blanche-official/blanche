...
from blanche.browser.node_type import A11yNode, HtmlSelector, NodeCategory
...
async def get_locator_for_node_id(
    ...
    if node.get("id") != node_id:
        raise ValueError(f"Node with blanche_id {node_id} not found in raw accessibility tree")
